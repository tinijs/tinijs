...
Elements live in the `elements` folder, the name of the file will be used in the class name `TiniFooElement` and the tag name `tini-foo`.

See the example **button element**: [elements/button.ts](https://github.com/tinijs/tinijs/blob/main/packages/ui/ui/elements/button.ts)

## Structure and functions

A element is structured as follow.
...
Souls are the styles of the elements, the name of the file must match the element name.
...
Beside styles, you can also provide the custom templates and scripts for the element. It is optional, but useful when you need addtional elements or behaviors.
