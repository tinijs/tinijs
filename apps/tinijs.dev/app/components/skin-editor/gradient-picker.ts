...
import {parseGradient} from '../../utils/gradient.js';

@Component()
export class AppSkinEditorGradientPickerComponent extends TiniComponent {
  static readonly defaultTagName = 'app-skin-editor-gradient-picker';
  ...
  static styles = css`
    ...
    .toggler {
      ...
      width: 50px;
      height: 27px;
      outline: var(--border-md) solid var(--color-medium);
