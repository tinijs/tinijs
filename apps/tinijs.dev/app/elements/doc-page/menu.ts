...
import {IconHomeElement} from '../../icons/home.js';
...
@element({
  elements: [IconHomeElement, TiniLinkElement, TiniSkeletonElement],
})
export class AppDocPageMenuElement extends TiniElement {
