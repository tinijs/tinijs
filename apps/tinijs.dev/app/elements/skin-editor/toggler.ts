...
import {element, TiniElement, Sizes} from '@tinijs/core';

import {MAIN_STORE} from '../../stores/main.js';

import {IconThemeElement} from '../../icons/theme.js';

@element({
  elements: [IconThemeElement],
})
export class AppSkinEditorTogglerElement extends TiniElement {
