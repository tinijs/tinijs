...
type ElementConstructor = typeof import('./icon.js').default;
...
export default class extends TiniElement {
  ...
  willUpdate(changedProperties: PropertyValues<this>) {
    ...
    // main styles
    const prebuiltSRC = (this.constructor as ElementConstructor).src;
    if (prebuiltSRC) {
      this.setHostStyles({
  ...
  private buildCustomSRC() {
    ...
    return (
      (this.constructor as ElementConstructor).resolve?.(
        this.name,
        this.provider
