...
export default css`:root {
  ...
  --letter-md: normal;
  /* shadows */
  --shadow-tiny: 0 0 0 1px #2525250d;
  ...
  --shadow-big: 0 20px 25px -5px #2525251a, 0 10px 10px -5px #2525250a;
  --shadow-huge: 0px 0px 0px 1px #2525251a, 0px 5px 10px #25252533, 0px 15px 40px #25252566;
}`;
