...
export default css`:root {
  ...
  --color-front: #ecedee;
  --color-front-subtle: #ecedee33;
  --color-front-contrast: #000000;
  --color-front-shade: #c6c7c8;
  --color-front-tint: #ffffff;
  --color-primary: #006fee;
  --color-primary-subtle: #006fee33;
  --color-primary-contrast: #ffffff;
  --color-primary-shade: #004fc7;
  --color-primary-tint: #5591ff;
  --color-secondary: #7828c8;
  --color-secondary-subtle: #7828c833;
  --color-secondary-contrast: #ffffff;
  --color-secondary-shade: #5000a2;
  --color-secondary-tint: #9f4eef;
  --color-info: #7ee7fc;
  --color-info-subtle: #7ee7fc33;
  --color-info-contrast: #000000;
  --color-info-shade: #54c1d6;
  --color-info-tint: #a6ffff;
  --color-success: #17c964;
  --color-success-subtle: #17c96433;
  --color-success-contrast: #ffffff;
  --color-success-shade: #00a342;
  --color-success-tint: #54f087;
  --color-warning: #f5a525;
  --color-warning-subtle: #f5a52533;
  --color-warning-contrast: #ffffff;
  --color-warning-shade: #cb8200;
  --color-warning-tint: #ffca4d;
  --color-danger: #f31d60;
  --color-danger-subtle: #f31d6033;
  --color-danger-contrast: #ffffff;
  --color-danger-shade: #c80041;
  --color-danger-tint: #ff5381;
  /* gradients */
  ...
  --letter-md: normal;
  /* shadows */
  --shadow-scarcity: 0 0 0 1px #18181a26;
  --shadow-tiny: 0 1px 2px 0 #18181a26;
  --shadow-small: 0 1px 3px 0 #18181a33, 0 1px 2px 0 #18181a29;
  --shadow-medium: 0 4px 6px -1px #18181a33, 0 2px 4px -1px #18181a29;
  --shadow-big: 0 10px 15px -3px #18181a33, 0 4px 6px -2px #18181a26;
  --shadow-huge: 0 20px 25px -5px #18181a33, 0 10px 10px -5px #18181a24;
  --shadow-excess: 0px 0px 0px 1px #18181a33, 0px 5px 10px #18181a4d, 0px 15px 40px #18181a80;
}`;
