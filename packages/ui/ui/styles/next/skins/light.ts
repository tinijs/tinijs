...
export default css`:root {
  ...
  --color-middle: #71717a;
  --color-middle-subtle: #71717a33;
  --color-middle-contrast: #ffffff;
  --color-middle-shade: #505059;
  --color-middle-tint: #94949d;
  --color-front: #11171c;
  --color-front-subtle: #11171c33;
  --color-front-contrast: #ffffff;
  --color-front-shade: #000000;
  --color-front-tint: #2d3339;
  ...
  --letter-md: normal;
  /* shadows */
  --shadow-scarcity: 0 0 0 1px #11171c0d;
  --shadow-tiny: 0 1px 2px 0 #11171c0d;
  --shadow-small: 0 1px 3px 0 #11171c1a, 0 1px 2px 0 #11171c0f;
  --shadow-medium: 0 4px 6px -1px #11171c1a, 0 2px 4px -1px #11171c0f;
  --shadow-big: 0 10px 15px -3px #11171c1a, 0 4px 6px -2px #11171c0d;
  --shadow-huge: 0 20px 25px -5px #11171c1a, 0 10px 10px -5px #11171c0a;
  --shadow-excess: 0px 0px 0px 1px #11171c1a, 0px 5px 10px #11171c33, 0px 15px 40px #11171c66;
}`;
