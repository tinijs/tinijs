...
export default css`:root {
  ...
  /* colors */
  --color-back: #f7fafc;
  --color-back-dim: #eaedef;
  --color-back-subtle: #f7fafc40;
  --color-back-contrast: #000000;
  --color-middle: #718096;
  --color-middle-dim: #7c8ca2;
  --color-middle-subtle: #71809640;
  --color-middle-contrast: #ffffff;
  --color-front: #1f2733;
  --color-front-dim: #29313d;
  --color-front-subtle: #1f273340;
  ...
  --gradient-middle: linear-gradient(to bottom, #718096 0%, #4e5e79 100%);
  --gradient-middle-dim: linear-gradient(to bottom, #7c8ca2 0%, #596984 100%);
  --gradient-middle-subtle: linear-gradient(to bottom, #71809640 0%, #4e5e7940 100%);
