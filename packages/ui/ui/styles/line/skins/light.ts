...
export default css`:root {
  ...
  /* colors */
  --color-back: #eeeeee;
  --color-back-subtle: #eeeeee33;
  --color-back-contrast: #000000;
  --color-back-shade: #c8c8c8;
  --color-back-tint: #ffffff;
  --color-middle: #9aa0a6;
  --color-middle-subtle: #9aa0a633;
  --color-middle-contrast: #ffffff;
  --color-middle-shade: #777d83;
  --color-middle-tint: #bec5cb;
  --color-front: #1f2123;
  --color-front-subtle: #1f212333;
  --color-front-contrast: #ffffff;
  --color-front-shade: #000001;
  --color-front-tint: #3c3e40;
  --color-primary: #2563eb;
  --color-primary-subtle: #2563eb33;
  --color-primary-contrast: #ffffff;
  --color-primary-shade: #0044c4;
  --color-primary-tint: #6084ff;
  --color-secondary: #1f2123;
  --color-secondary-subtle: #1f212333;
  --color-secondary-contrast: #ffffff;
  --color-secondary-shade: #000001;
  --color-secondary-tint: #3c3e40;
  --color-info: #3a989d;
  --color-info-subtle: #3a989d33;
  --color-info-contrast: #ffffff;
  --color-info-shade: #00757a;
  --color-info-tint: #62bdc1;
  --color-success: #02a84c;
  --color-success-subtle: #02a84c33;
  --color-success-contrast: #ffffff;
  --color-success-shade: #00832b;
  --color-success-tint: #47ce6e;
  --color-warning: #f2c008;
  --color-warning-subtle: #f2c00833;
  --color-warning-contrast: #000000;
  --color-warning-shade: #c89c00;
  --color-warning-tint: #ffe642;
  --color-danger: #e94335;
  --color-danger-subtle: #e9433533;
  --color-danger-contrast: #ffffff;
  --color-danger-shade: #be1016;
  --color-danger-tint: #ff6b55;
  /* gradients */
  ...
  --letter-md: normal;
  /* shadows */
  --shadow-scarcity: 0 0 0 1px #1f21230d;
  --shadow-tiny: 0 1px 2px 0 #1f21230d;
  --shadow-small: 0 1px 3px 0 #1f21231a, 0 1px 2px 0 #1f21230f;
  --shadow-medium: 0 4px 6px -1px #1f21231a, 0 2px 4px -1px #1f21230f;
  --shadow-big: 0 10px 15px -3px #1f21231a, 0 4px 6px -2px #1f21230d;
  --shadow-huge: 0 20px 25px -5px #1f21231a, 0 10px 10px -5px #1f21230a;
  --shadow-excess: 0px 0px 0px 1px #1f21231a, 0px 5px 10px #1f212333, 0px 15px 40px #1f212366;
}`;
