...
export default css`:root {
  ...
  /* colors */
  --color-back: #1f2123;
  --color-back-subtle: #1f212333;
  --color-back-contrast: #ffffff;
  --color-back-shade: #000001;
  --color-back-tint: #3c3e40;
  --color-middle: #9aa0a6;
  ...
  --color-secondary-subtle: #eeeeee33;
  --color-secondary-contrast: #000000;
  --color-secondary-shade: #c8c8c8;
  ...
  --letter-md: normal;
  /* shadows */
  --shadow-scarcity: 0 0 0 1px #1f212326;
  --shadow-tiny: 0 1px 2px 0 #1f212326;
  --shadow-small: 0 1px 3px 0 #1f212333, 0 1px 2px 0 #1f212329;
  --shadow-medium: 0 4px 6px -1px #1f212333, 0 2px 4px -1px #1f212329;
  --shadow-big: 0 10px 15px -3px #1f212333, 0 4px 6px -2px #1f212326;
  --shadow-huge: 0 20px 25px -5px #1f212333, 0 10px 10px -5px #1f212324;
  --shadow-excess: 0px 0px 0px 1px #1f212333, 0px 5px 10px #1f21234d, 0px 15px 40px #1f212380;
}`;
