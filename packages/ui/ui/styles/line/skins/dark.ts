...
export default css`:root {
  ...
  --gradient-medium: linear-gradient(180deg, #bfbfbf 0%, #6a6b6c 100%);
  --gradient-medium-subtle: linear-gradient(180deg, #bfbfbf33 0%, #6a6b6c33 100%);
  --gradient-medium-contrast: linear-gradient(180deg, #000000 0%, #555555 100%);
  --gradient-medium-shade: linear-gradient(180deg, #9b9b9b 0%, #4a4b4c 100%);
  --gradient-medium-tint: linear-gradient(180deg, #e5e5e5 0%, #8c8d8e 100%);
