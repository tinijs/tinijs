...
export default css`:root {
  ...
  --gradient-tertiary-subtle: linear-gradient(135deg, #6370ff33 0%, #242e9e33 100%);
  --gradient-tertiary-contrast: linear-gradient(135deg, #ffffff 0%, #9b9b9b 100%);
  --gradient-tertiary-shade: linear-gradient(135deg, #1545cb 0%, #00096e 100%);
  ...
  --gradient-dark-subtle: linear-gradient(135deg, #6b6b6b33 0%, #21212133 100%);
  ...
  --gradient-light-subtle: linear-gradient(135deg, #ffffff33 0%, #c8c8c833 100%);
  --gradient-light-contrast: linear-gradient(135deg, #000000 0%, #555555 100%);
  ...
  --gradient-background-subtle: linear-gradient(135deg, #6b6b6b33 0%, #21212133 100%);
  --gradient-background-contrast: linear-gradient(135deg, #ffffff 0%, #9b9b9b 100%);
  --gradient-background-shade: linear-gradient(135deg, #404040 0%, #000000 100%);
  --gradient-background-tint: linear-gradient(135deg, #999999 0%, #484848 100%);
  --gradient-middleground: linear-gradient(135deg, #c8c9cb 0%, #747781 100%);
  --gradient-middleground-subtle: linear-gradient(135deg, #c8c9cb33 0%, #74778133 100%);
  --gradient-middleground-contrast: linear-gradient(135deg, #000000 0%, #555555 100%);
  --gradient-middleground-shade: linear-gradient(135deg, #97989a 0%, #484b55 100%);
  --gradient-middleground-tint: linear-gradient(135deg, #fbfcfe 0%, #a3a6b0 100%);
  --gradient-foreground: linear-gradient(135deg, #ffffff 0%, #c8c8c8 100%);
  --gradient-foreground-subtle: linear-gradient(135deg, #ffffff33 0%, #c8c8c833 100%);
  --gradient-foreground-contrast: linear-gradient(135deg, #000000 0%, #555555 100%);
  --gradient-foreground-shade: linear-gradient(135deg, #cccccc 0%, #979797 100%);
  --gradient-foreground-tint: linear-gradient(135deg, #ffffff 0%, #fbfbfb 100%);
  /* sizes */
  --size-text: 16px;
  --size-space: 1rem;
  --size-outline: 1px;
