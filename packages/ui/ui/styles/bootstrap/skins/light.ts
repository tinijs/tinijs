...
export default css`:root {
  ...
  --gradient-background-subtle: linear-gradient(135deg, #ffffff33 0%, #c8c8c833 100%);
  --gradient-background-contrast: linear-gradient(135deg, #000000 0%, #555555 100%);
  --gradient-background-shade: linear-gradient(135deg, #cccccc 0%, #979797 100%);
  --gradient-background-tint: linear-gradient(135deg, #ffffff 0%, #fbfbfb 100%);
  ...
  --gradient-foreground-subtle: linear-gradient(135deg, #6b6b6b33 0%, #21212133 100%);
  --gradient-foreground-contrast: linear-gradient(135deg, #ffffff 0%, #9b9b9b 100%);
  --gradient-foreground-shade: linear-gradient(135deg, #404040 0%, #000000 100%);
  --gradient-foreground-tint: linear-gradient(135deg, #999999 0%, #484848 100%);
  /* sizes */
  --size-text: 16px;
  --size-space: 1rem;
  --size-outline: 1px;
