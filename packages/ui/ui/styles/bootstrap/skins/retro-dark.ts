...
export default css`:root {
  ...
  --gradient-background-subtle: linear-gradient(180deg, #5e616433 0%, #12141733 100%);
  --gradient-background-contrast: linear-gradient(180deg, #ffffff 0%, #9b9b9b 100%);
  --gradient-background-shade: linear-gradient(180deg, #3e4144 0%, #000000 100%);
  --gradient-background-tint: linear-gradient(180deg, #808386 0%, #2e3033 100%);
  ...
  --gradient-foreground-subtle: linear-gradient(180deg, #ffffff33 0%, #cccccc33 100%);
  --gradient-foreground-contrast: linear-gradient(180deg, #000000 0%, #555555 100%);
  --gradient-foreground-shade: linear-gradient(180deg, #d8d8d8 0%, #a7a7a7 100%);
  --gradient-foreground-tint: linear-gradient(180deg, #ffffff 0%, #f2f2f2 100%);
  /* sizes */
  --size-text: 16px;
  --size-space: 1rem;
  --size-outline: 1px;
