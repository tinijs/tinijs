...
export default css`:root {
  ...
  --gradient-middle: linear-gradient(180deg, #475569 0%, #2b3d55 100%);
  --gradient-middle-subtle: linear-gradient(180deg, #47556933 0%, #2b3d5533 100%);
  --gradient-middle-contrast: linear-gradient(180deg, #ffffff 0%, #9b9b9b 100%);
  --gradient-middle-shade: linear-gradient(180deg, #283649 0%, #0b2036 100%);
  --gradient-middle-tint: linear-gradient(180deg, #68768b 0%, #4b5c76 100%);
