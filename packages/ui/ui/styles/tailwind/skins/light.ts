...
export default css`:root {
  ...
  /* colors */
  --color-back: #f8fafc;
  --color-back-dim: #ebedef;
  --color-back-subtle: #f8fafc40;
  --color-back-contrast: #000000;
  --color-middle: #475569;
  --color-middle-dim: #526074;
  --color-middle-subtle: #47556940;
  --color-middle-contrast: #ffffff;
  --color-front: #0f1720;
  --color-front-dim: #182029;
  --color-front-subtle: #0f172040;
  ...
  --gradient-middle: linear-gradient(to bottom, #475569 0%, #2b3d55 100%);
  --gradient-middle-dim: linear-gradient(to bottom, #526074 0%, #364760 100%);
  --gradient-middle-subtle: linear-gradient(to bottom, #47556940 0%, #2b3d5540 100%);
