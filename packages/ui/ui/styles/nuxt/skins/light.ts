...
export default css`:root {
  ...
  /* colors */
  --color-back: #f1f5fa;
  --color-back-subtle: #f1f5fa33;
  --color-back-contrast: #000000;
  --color-back-shade: #cbcfd4;
  --color-back-tint: #ffffff;
  --color-middle: #909295;
  --color-middle-subtle: #90929533;
  --color-middle-contrast: #ffffff;
  --color-middle-shade: #6e7072;
  --color-middle-tint: #b4b6b9;
  --color-front: #1f1f21;
  --color-front-subtle: #1f1f2133;
  --color-front-contrast: #ffffff;
  --color-front-shade: #000000;
  --color-front-tint: #3c3c3e;
