...
export interface LayoutProps {
  ...
  overflowX?: LayoutProps['overflow'];
  overflowY?: LayoutProps['overflow'];
  order?: string;
  zIndex?: string;
  // size
  width?: string;
...
export class BaseLayoutElement extends TiniElement {
  ...
  @property({type: String, reflect: true}) overflowX?: LayoutProps['overflow'];
  @property({type: String, reflect: true}) overflowY?: LayoutProps['overflow'];
  ...
  protected composeStyles(props: LayoutProps) {
    ...
    if (props.move) result.push(`translate: ${props.move};`);
